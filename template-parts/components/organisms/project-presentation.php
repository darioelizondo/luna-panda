...
<div class="projects-home__inner container grid-columns-l--12">
    ...
    <?php
        ...
        if ( $query->have_posts() ) :
            ...
            $image_mobile_col_span                 = (int)($project_presentation['image_mobile_col_span'] ?? 2);
            $content_mobile_col_span               = (int)($project_presentation['content_mobile_col_span'] ?? 2);
            $logo_mobile_col_span                  = (int)($project_presentation['logo_mobile_col_span'] ?? 1);
            $title_tags_mobile_col_span            = (int)($project_presentation['title_tags_mobile_col_span'] ?? 1);
            $short_line_button_mobile_col_span     = (int)($project_presentation['short_line_and_button_mobile_col_span'] ?? 1);

            // Layout settings - Desktop
            $image_col_span                        = (int)($project_presentation['image_col_span'] ?? 4);
            $content_col_span                      = (int)($project_presentation['content_col_span'] ?? 4);
            $logo_col_span                         = (int)($project_presentation['logo_col_span'] ?? 1);
            $title_tags_col_span                   = (int)($project_presentation['title_tags_col_span'] ?? 1);
            $short_line_button_col_span            = (int)($project_presentation['short_line_and_button_col_span'] ?? 1);
